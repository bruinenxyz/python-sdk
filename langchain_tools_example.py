...
from ..langchain_tools.github_test import GithubGetReposTool
...
from ..bruinen_api_client.models import UpsertUserDto, ReturnedUserDto
...
request_object = UpsertUserDto.from_dict({'email': tyler_email, 'client_id': bruinen_client_id })
response: Response[ReturnedUserDto] = users_controller_find_or_create_user.sync_detailed(client=client, json_body=request_object)
