...
class SQLParser:
    ...
    def parse(self, input, query):
        ...
        class_attrs = {"__tablename__": input_class_name.lower(), "temporary_id": Column(Integer, primary_key=True)}
        ...
        engine = create_engine(f"sqlite:///notebooks/{input_class_name.lower()}.db", echo=True)
        ...
        db = SQLDatabase.from_uri(f"sqlite:///notebooks/{input_class_name.lower()}.db")
