...
T = TypeVar("T", bound="GoogleEventRemindersOverridesItem")


@attr.s(auto_attribs=True)
class GoogleEventRemindersOverridesItem:
    """A reminder override
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_event_reminders_overrides_item = cls(
            method=method,
            minutes=minutes,
        )

        google_event_reminders_overrides_item.additional_properties = d
        return google_event_reminders_overrides_item
