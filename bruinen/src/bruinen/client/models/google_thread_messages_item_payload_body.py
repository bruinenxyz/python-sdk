...
T = TypeVar("T", bound="GoogleThreadMessagesItemPayloadBody")


@attr.s(auto_attribs=True)
class GoogleThreadMessagesItemPayloadBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_thread_messages_item_payload_body = cls(
            size=size,
            data=data,
            attachment_id=attachment_id,
        )

        google_thread_messages_item_payload_body.additional_properties = d
        return google_thread_messages_item_payload_body
