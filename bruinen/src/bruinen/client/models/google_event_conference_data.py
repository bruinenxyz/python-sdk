...
if TYPE_CHECKING:
    from ..models.google_event_conference_data_conference_solution import GoogleEventConferenceDataConferenceSolution
    from ..models.google_event_conference_data_create_request import GoogleEventConferenceDataCreateRequest
    from ..models.google_event_conference_data_entry_points_item import GoogleEventConferenceDataEntryPointsItem


T = TypeVar("T", bound="GoogleEventConferenceData")


@attr.s(auto_attribs=True)
class GoogleEventConferenceData:
    """The conferenceData of the event

    Attributes:
        create_request (Union[Unset, GoogleEventConferenceDataCreateRequest]): The createRequest of the conferenceData
        entry_points (Union[Unset, List['GoogleEventConferenceDataEntryPointsItem']]): The entryPoints of the
            conferenceData
        conference_solution (Union[Unset, GoogleEventConferenceDataConferenceSolution]): The conferenceSolution of the
            conferenceData
    ...
    create_request: Union[Unset, "GoogleEventConferenceDataCreateRequest"] = UNSET
    entry_points: Union[Unset, List["GoogleEventConferenceDataEntryPointsItem"]] = UNSET
    conference_solution: Union[Unset, "GoogleEventConferenceDataConferenceSolution"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.google_event_conference_data_conference_solution import (
        ...
        create_request: Union[Unset, GoogleEventConferenceDataCreateRequest]
        if isinstance(_create_request, Unset):
            create_request = UNSET
        else:
            create_request = GoogleEventConferenceDataCreateRequest.from_dict(_create_request)

        entry_points = []
        _entry_points = d.pop("entryPoints", UNSET) or UNSET
        for entry_points_item_data in _entry_points or []:
            entry_points_item = GoogleEventConferenceDataEntryPointsItem.from_dict(entry_points_item_data)

            entry_points.append(entry_points_item)

        _conference_solution = d.pop("conferenceSolution", UNSET) or UNSET
        conference_solution: Union[Unset, GoogleEventConferenceDataConferenceSolution]
        if isinstance(_conference_solution, Unset):
            conference_solution = UNSET
        else:
            conference_solution = GoogleEventConferenceDataConferenceSolution.from_dict(_conference_solution)
        ...
        google_event_conference_data = cls(
        ...
        google_event_conference_data.additional_properties = d
        return google_event_conference_data
