...
T = TypeVar("T", bound="GoogleParsedMessageAttachmentsItem")


@attr.s(auto_attribs=True)
class GoogleParsedMessageAttachmentsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_parsed_message_attachments_item = cls(
        ...
        google_parsed_message_attachments_item.additional_properties = d
        return google_parsed_message_attachments_item
