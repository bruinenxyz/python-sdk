...
T = TypeVar("T", bound="GoogleMessagePayloadBody")


@attr.s(auto_attribs=True)
class GoogleMessagePayloadBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_message_payload_body = cls(
            size=size,
            data=data,
            attachment_id=attachment_id,
        )

        google_message_payload_body.additional_properties = d
        return google_message_payload_body
