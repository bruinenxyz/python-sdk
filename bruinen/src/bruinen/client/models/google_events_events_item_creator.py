...
T = TypeVar("T", bound="GoogleEventsEventsItemCreator")


@attr.s(auto_attribs=True)
class GoogleEventsEventsItemCreator:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_events_events_item_creator = cls(
            id=id,
            email=email,
        ...
        google_events_events_item_creator.additional_properties = d
        return google_events_events_item_creator
