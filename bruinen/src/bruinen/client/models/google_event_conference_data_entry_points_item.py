...
T = TypeVar("T", bound="GoogleEventConferenceDataEntryPointsItem")


@attr.s(auto_attribs=True)
class GoogleEventConferenceDataEntryPointsItem:
    """An entryPoint
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_event_conference_data_entry_points_item = cls(
        ...
        google_event_conference_data_entry_points_item.additional_properties = d
        return google_event_conference_data_entry_points_item
