...
if TYPE_CHECKING:
    from ..models.google_events_events_item_attachments_item import GoogleEventsEventsItemAttachmentsItem
    from ..models.google_events_events_item_attendees_item import GoogleEventsEventsItemAttendeesItem
    from ..models.google_events_events_item_conference_data import GoogleEventsEventsItemConferenceData
    from ..models.google_events_events_item_creator import GoogleEventsEventsItemCreator
    from ..models.google_events_events_item_end import GoogleEventsEventsItemEnd
    from ..models.google_events_events_item_extended_properties import GoogleEventsEventsItemExtendedProperties
    from ..models.google_events_events_item_gadget import GoogleEventsEventsItemGadget
    from ..models.google_events_events_item_organizer import GoogleEventsEventsItemOrganizer
    from ..models.google_events_events_item_original_start_time import GoogleEventsEventsItemOriginalStartTime
    from ..models.google_events_events_item_reminders import GoogleEventsEventsItemReminders
    from ..models.google_events_events_item_source import GoogleEventsEventsItemSource
    from ..models.google_events_events_item_start import GoogleEventsEventsItemStart


T = TypeVar("T", bound="GoogleEventsEventsItem")


@attr.s(auto_attribs=True)
class GoogleEventsEventsItem:
    """An event
    ...
    Attributes:
        ...
        creator (Union[Unset, GoogleEventsEventsItemCreator]): The creator of the event
        organizer (Union[Unset, GoogleEventsEventsItemOrganizer]): The organizer of the event
        start (Union[Unset, GoogleEventsEventsItemStart]): The start of the event
        end (Union[Unset, GoogleEventsEventsItemEnd]): The end of the event
        ...
        original_start_time (Union[Unset, GoogleEventsEventsItemOriginalStartTime]): The originalStartTime of the event
        ...
        attendees (Union[Unset, List['GoogleEventsEventsItemAttendeesItem']]): The attendees of the event
        attendees_omitted (Union[Unset, bool]): Whether attendees are omitted
        extended_properties (Union[Unset, GoogleEventsEventsItemExtendedProperties]): The extendedProperties of the
            event
        hangout_link (Union[Unset, str]): The hangoutLink of the event
        conference_data (Union[Unset, GoogleEventsEventsItemConferenceData]): The conferenceData of the event
        gadget (Union[Unset, GoogleEventsEventsItemGadget]): The gadget of the event
        ...
        reminders (Union[Unset, GoogleEventsEventsItemReminders]): The reminders of the event
        source (Union[Unset, GoogleEventsEventsItemSource]): The source of the event
        attachments (Union[Unset, List['GoogleEventsEventsItemAttachmentsItem']]): The attachments of the event
    ...
    creator: Union[Unset, "GoogleEventsEventsItemCreator"] = UNSET
    organizer: Union[Unset, "GoogleEventsEventsItemOrganizer"] = UNSET
    start: Union[Unset, "GoogleEventsEventsItemStart"] = UNSET
    end: Union[Unset, "GoogleEventsEventsItemEnd"] = UNSET
    end_time_unspecified: Union[Unset, bool] = UNSET
    recurrence: Union[Unset, List[str]] = UNSET
    recurring_event_id: Union[Unset, str] = UNSET
    original_start_time: Union[Unset, "GoogleEventsEventsItemOriginalStartTime"] = UNSET
    transparency: Union[Unset, str] = UNSET
    visibility: Union[Unset, str] = UNSET
    i_cal_uid: Union[Unset, str] = UNSET
    sequence: Union[Unset, float] = UNSET
    attendees: Union[Unset, List["GoogleEventsEventsItemAttendeesItem"]] = UNSET
    attendees_omitted: Union[Unset, bool] = UNSET
    extended_properties: Union[Unset, "GoogleEventsEventsItemExtendedProperties"] = UNSET
    hangout_link: Union[Unset, str] = UNSET
    conference_data: Union[Unset, "GoogleEventsEventsItemConferenceData"] = UNSET
    gadget: Union[Unset, "GoogleEventsEventsItemGadget"] = UNSET
    ...
    reminders: Union[Unset, "GoogleEventsEventsItemReminders"] = UNSET
    source: Union[Unset, "GoogleEventsEventsItemSource"] = UNSET
    attachments: Union[Unset, List["GoogleEventsEventsItemAttachmentsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        creator: Union[Unset, GoogleEventsEventsItemCreator]
        if isinstance(_creator, Unset):
            creator = UNSET
        else:
            creator = GoogleEventsEventsItemCreator.from_dict(_creator)

        _organizer = d.pop("organizer", UNSET) or UNSET
        organizer: Union[Unset, GoogleEventsEventsItemOrganizer]
        if isinstance(_organizer, Unset):
            organizer = UNSET
        else:
            organizer = GoogleEventsEventsItemOrganizer.from_dict(_organizer)

        _start = d.pop("start", UNSET) or UNSET
        start: Union[Unset, GoogleEventsEventsItemStart]
        if isinstance(_start, Unset):
            start = UNSET
        else:
            start = GoogleEventsEventsItemStart.from_dict(_start)

        _end = d.pop("end", UNSET) or UNSET
        end: Union[Unset, GoogleEventsEventsItemEnd]
        if isinstance(_end, Unset):
            end = UNSET
        else:
            end = GoogleEventsEventsItemEnd.from_dict(_end)
        ...
        original_start_time: Union[Unset, GoogleEventsEventsItemOriginalStartTime]
        if isinstance(_original_start_time, Unset):
            original_start_time = UNSET
        else:
            original_start_time = GoogleEventsEventsItemOriginalStartTime.from_dict(_original_start_time)
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = GoogleEventsEventsItemAttendeesItem.from_dict(attendees_item_data)
        ...
        extended_properties: Union[Unset, GoogleEventsEventsItemExtendedProperties]
        if isinstance(_extended_properties, Unset):
            extended_properties = UNSET
        else:
            extended_properties = GoogleEventsEventsItemExtendedProperties.from_dict(_extended_properties)

        hangout_link = d.pop("hangoutLink", UNSET) or UNSET

        _conference_data = d.pop("conferenceData", UNSET) or UNSET
        conference_data: Union[Unset, GoogleEventsEventsItemConferenceData]
        if isinstance(_conference_data, Unset):
            conference_data = UNSET
        else:
            conference_data = GoogleEventsEventsItemConferenceData.from_dict(_conference_data)

        _gadget = d.pop("gadget", UNSET) or UNSET
        gadget: Union[Unset, GoogleEventsEventsItemGadget]
        if isinstance(_gadget, Unset):
            gadget = UNSET
        else:
            gadget = GoogleEventsEventsItemGadget.from_dict(_gadget)
        ...
        reminders: Union[Unset, GoogleEventsEventsItemReminders]
        if isinstance(_reminders, Unset):
            reminders = UNSET
        else:
            reminders = GoogleEventsEventsItemReminders.from_dict(_reminders)

        _source = d.pop("source", UNSET) or UNSET
        source: Union[Unset, GoogleEventsEventsItemSource]
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = GoogleEventsEventsItemSource.from_dict(_source)

        attachments = []
        _attachments = d.pop("attachments", UNSET) or UNSET
        for attachments_item_data in _attachments or []:
            attachments_item = GoogleEventsEventsItemAttachmentsItem.from_dict(attachments_item_data)

            attachments.append(attachments_item)

        event_type = d.pop("eventType", UNSET) or UNSET

        google_events_events_item = cls(
            kind=kind,
            etag=etag,
            id=id,
            status=status,
        ...
        google_events_events_item.additional_properties = d
        return google_events_events_item
