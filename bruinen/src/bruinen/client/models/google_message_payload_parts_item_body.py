...
T = TypeVar("T", bound="GoogleMessagePayloadPartsItemBody")


@attr.s(auto_attribs=True)
class GoogleMessagePayloadPartsItemBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_message_payload_parts_item_body = cls(
            size=size,
            data=data,
            attachment_id=attachment_id,
        )

        google_message_payload_parts_item_body.additional_properties = d
        return google_message_payload_parts_item_body
