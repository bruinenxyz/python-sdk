...
T = TypeVar("T", bound="GoogleEventsEventsItemAttachmentsItem")


@attr.s(auto_attribs=True)
class GoogleEventsEventsItemAttachmentsItem:
    """An attachment
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_events_events_item_attachments_item = cls(
            file_url=file_url,
            title=title,
            mime_type=mime_type,
            icon_link=icon_link,
        ...
        google_events_events_item_attachments_item.additional_properties = d
        return google_events_events_item_attachments_item
