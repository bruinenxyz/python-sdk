...
T = TypeVar("T", bound="GoogleEventsDefaultRemindersItem")


@attr.s(auto_attribs=True)
class GoogleEventsDefaultRemindersItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_events_default_reminders_item = cls(
            method=method,
            minutes=minutes,
        )

        google_events_default_reminders_item.additional_properties = d
        return google_events_default_reminders_item
