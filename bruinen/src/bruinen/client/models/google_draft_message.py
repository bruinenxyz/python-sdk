...
if TYPE_CHECKING:
    from ..models.google_draft_message_payload import GoogleDraftMessagePayload


T = TypeVar("T", bound="GoogleDraftMessage")


@attr.s(auto_attribs=True)
class GoogleDraftMessage:
    ...
    Attributes:
        ...
        payload (Union[Unset, GoogleDraftMessagePayload]): The payload of the message
        size_estimate (Union[Unset, float]): The sizeEstimate of the message
        raw (Union[Unset, str]): The raw message
    """
    ...
    payload: Union[Unset, "GoogleDraftMessagePayload"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payload: Union[Unset, GoogleDraftMessagePayload]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = GoogleDraftMessagePayload.from_dict(_payload)

        size_estimate = d.pop("sizeEstimate", UNSET) or UNSET

        raw = d.pop("raw", UNSET) or UNSET

        google_draft_message = cls(
            id=id,
            thread_id=thread_id,
            label_ids=label_ids,
            snippet=snippet,
        ...
        google_draft_message.additional_properties = d
        return google_draft_message
