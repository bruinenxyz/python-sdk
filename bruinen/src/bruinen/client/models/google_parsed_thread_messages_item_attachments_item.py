...
T = TypeVar("T", bound="GoogleParsedThreadMessagesItemAttachmentsItem")


@attr.s(auto_attribs=True)
class GoogleParsedThreadMessagesItemAttachmentsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_parsed_thread_messages_item_attachments_item = cls(
        ...
        google_parsed_thread_messages_item_attachments_item.additional_properties = d
        return google_parsed_thread_messages_item_attachments_item
