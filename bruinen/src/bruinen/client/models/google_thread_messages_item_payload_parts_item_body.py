...
T = TypeVar("T", bound="GoogleThreadMessagesItemPayloadPartsItemBody")


@attr.s(auto_attribs=True)
class GoogleThreadMessagesItemPayloadPartsItemBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_thread_messages_item_payload_parts_item_body = cls(
            size=size,
            data=data,
            attachment_id=attachment_id,
        )

        google_thread_messages_item_payload_parts_item_body.additional_properties = d
        return google_thread_messages_item_payload_parts_item_body
