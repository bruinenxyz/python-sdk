...
T = TypeVar("T", bound="GoogleEventsEventsItemEnd")


@attr.s(auto_attribs=True)
class GoogleEventsEventsItemEnd:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_events_events_item_end = cls(
            date=date,
            date_time=date_time,
            time_zone=time_zone,
        )

        google_events_events_item_end.additional_properties = d
        return google_events_events_item_end
