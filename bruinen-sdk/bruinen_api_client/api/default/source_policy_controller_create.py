...
from ...models.create_source_policy_dto import CreateSourcePolicyDto
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateSourcePolicyDto,
) -> Dict[str, Any]:
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ReturnedSourcePolicyDto]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = ReturnedSourcePolicyDto.from_dict(response.json())
