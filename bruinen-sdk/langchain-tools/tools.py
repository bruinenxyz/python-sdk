...
class BruinenVenmo:
    ...
    def run(self, query):
        ...
        if account_id == "":
            ...
            res_transactions = requests.get(
                f"https://api.bruinen.co/sources/venmo/transactions?accountId={account_id}", headers=headers
            )
    ...
    def run(self, query):
        ...
        if account_id == "":
            ...
            res_messages = requests.get(
                f"https://api.bruinen.co/sources/google/gmailMessages?accountId={account_id}", headers=headers
            )
            ...
            for message in messages["messages"]:
                ...
                res_message = requests.get(
                    f"https://api.bruinen.co/sources/google/gmailMessage?accountId={account_id}&messageId={message_id}",
                    headers=headers,
                )
