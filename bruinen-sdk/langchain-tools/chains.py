...
from tools import BruinenGmail, BruinenGmailAuthenticator, BruinenVenmo, BruinenVenmoAuthenticator
...
class DocumentResponder:
    def __init__(self):
        ...
        venmo = BruinenVenmo()
        venmo_tool = Tool(name=BruinenVenmo.name, description=BruinenVenmo.description, func=venmo.run)
        venmo_auth = BruinenVenmoAuthenticator()
        venmo_auth_tool = Tool(
            name=BruinenVenmoAuthenticator.name, description=BruinenVenmoAuthenticator.description, func=venmo_auth.run
        )

        # Gmail source and authenticator
        gmail = BruinenGmail()
        gmail_tool = Tool(name=BruinenGmail.name, description=BruinenGmail.description, func=gmail.run)
        gmail_auth = BruinenGmailAuthenticator()
        gmail_auth_tool = Tool(
            name=BruinenGmailAuthenticator.name, description=BruinenGmailAuthenticator.description, func=gmail_auth.run
        )
